...
public class ExtraIntegration {
    ...
    public static RewardType TIMER;
    ...
    public void registerRewards(RegistryEvent.Register<RewardType> event) {
        ...
        event.getRegistry().register(TIMER = new RewardType(TimerReward::new).setRegistryName("timer").setIcon(Icon.getIcon("minecraft:items/clock_07")));
    }
}