...
public class LocaleConfig {
    ...
    private String extraQuestsCommand = "&e/extraquests add <player> <key> <amount> | reload";
    ...
    public String getExtraQuestsCommand() {
        return this.extraQuestsCommand;
    }
    ...
    public void init() {
        try {
            CompletableFuture<Boolean> future = UtilGson.readFileAsync("/config/ExtraQuests/", "locale.json", el -> {
                ...
                this.extraQuestsCommand = config.getExtraQuestsCommand();
