...
public class KeyValueTask extends Task {
    ...
    public TranslatableComponent getAltTitle() {
        return new TranslatableComponent("extraquests.key_value.title", this.key, this.value);
    }

    @Override
    @Environment(EnvType.CLIENT)
    public TranslatableComponent getButtonText() {
        return new TranslatableComponent(String.valueOf(this.value));
    }
